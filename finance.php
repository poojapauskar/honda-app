...
<?php
$url_types_subtypes = 'https://hondaproject.herokuapp.com/web_get_vehicle_types_subtypes/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
...
if(($_POST['mobile'] == '' || $_POST['mobile'] == 'null') &&  isset($_POST['finance_btn'])){
  ...
  if($arr_finance['status'] == 200){
            ...
            /*Get Signed Urls*/
            $url = 'https://hondaproject.herokuapp.com/get_signed_url/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
            ...
            for($i=0;$i<count($arr);$i++){
                ...
                $url_update_doc_tab = 'https://hondaproject.herokuapp.com/documents/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
...
<div class="demo-layout-transparent mdl-layout mdl-js-layout">
     ...
     box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23) !important;" class="mdl-layout__header mdl-layout__header--transparent">
      ...
      <div class="mdl-layout__drawer">
        <span class="mdl-layout-title">Honda</span>
        <nav class="mdl-navigation">
...
<!-- Added label over the SelectField -->
          <div class="demo" >
           <label class="mdl-selectfield__label" for="v_id" style="color:#cccccc;margin-top:61%;margin-left:5%;font-size:13px;">Vehicle</label>
              ...
              <select style="" class="mdl-selectfield__select"  name="v_id" id="v_id">
                
                      
<?php

if($_POST['v_id'] != ''){
  $url_details_of_selected_vehicle = 'https://hondaproject.herokuapp.com/get_details_of_selected_vehicle/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
...
<div style="background-color:#607D8B;border-bottom:1px solid #688491;margin-top:11%" class="mdl-mini-footer">
  ...
  <div class="col-sm-3" style="color:white;">
       <div style="margin-top:5%">
        ...
        <h5 style="margin-top:-6%;margin-left:25%">Honda</h5>
       </div>
  </div>
