...
<div class="mdl-layout__content" style="text-align:justify;margin-top:4%;padding-bottom: 25px;">
               ...
               <div class="col-sm-2">
                   ...
                   <div class="row">
                      <p style="text-align:-webkit-left;letter-spacing: 0.01em;width: 228px">"I am a happy customer for a period of 4 year. I own an Activa 3G, which I can completely rely on Honda for any maintainence. Undivided attention to customers".</p>
                   </div>
               </div>
...
">
  ...
  <div class="col-sm-3" style="color:#FFFFFF;">
       <div style="margin-top:5%;">
        ...
        <h5 style="margin-top:-6.5%;margin-left:-25%">Honda</h5>
       </div>
  </div>
