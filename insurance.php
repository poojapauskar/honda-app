...
if(($_POST['v_id'] == '' || $_POST['v_id'] == 'null') &&  isset($_POST['insurance_btn'])){
  ...
  $url_insurance = 'https://hondaproject.herokuapp.com/web_app_insurance/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
...
<div class="demo-layout-transparent mdl-layout mdl-js-layout">
     ...
     box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23) !important;" class="mdl-layout__header mdl-layout__header--transparent">
        <div class="mdl-layout__header-row" style="margin-top:58%">
          <!-- Title -->
...
<div style="background-color:#607D8B;border-bottom:1px solid #688491;margin-top:11%" class="mdl-mini-footer">
  ...
  <div class="col-sm-3" style="color:white;">
       <div style="margin-top:5%;margin-left:-24%">
        ...
        <h5 style="margin-top:-5.5%;margin-left:22%">Honda</h5>
       </div>
  </div>
