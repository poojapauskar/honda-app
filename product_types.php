...
<?php
$url_vehicle_types = 'https://hondaproject.herokuapp.com/web_vehicle_types/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
...
/*echo count($arr_vehicle_types[0]['results']);*/
?>
...
<div class="mdl-layout" style="background-color:white;margin-top:1%;text-align:center">
  ...
  <?php for($x=0;$x<count($arr_vehicle_types[0]['results']);$x++){
    $image_url="http://res.cloudinary.com/hdccr1s1j/image/upload/v1508400099/honda/".$arr_vehicle_types[0]['results'][$x]['link'];?>
    <div class="col-sm-4"  style="margin-bottom:5%;">
      <a href="single_type.php?type_id=<?php echo $arr_vehicle_types[0]['results'][$x]['pk']?>">
...
<div style="background-color:#607D8B;border-bottom:1px solid #688491;margin-top:1%" class="mdl-mini-footer">
  ...
  <div class="col-sm-3" style="color:white;">
       <div style="margin-top:5%">
        ...
        <h5 style="margin-top:-6%;margin-left:29%">Honda</h5>
       </div>
  </div>
