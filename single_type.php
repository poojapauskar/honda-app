...
<?php
/*echo $_GET['type_id'];*/
$url_vehicles_of_particular_type = 'https://hondaproject.herokuapp.com/get_all_vehicles_of_particular_type/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
...
<div class="row" style="margin-top:6%;text-align:center">
  <?php for($x=0;$x<count($arr_vehicles_of_particular_type);$x++){
    ...
    $image_url="http://res.cloudinary.com/hdccr1s1j/image/upload/v1508400099/honda/".$arr_vehicles_of_particular_type[$x]['image_details']['link'];
