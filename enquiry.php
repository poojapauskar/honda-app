...
if(($_POST['mobile'] == '' || $_POST['mobile'] == 'null') &&  isset($_POST['enq_btn'])){
  ...
  $url_web_enquiry = 'https://hondaproject.herokuapp.com/web_app_enquiry/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP';
...
<div style="background-color:#607D8B;border-bottom:1px solid #688491;" class="mdl-mini-footer">
  ...
  <div class="col-sm-3" style="color:white;">
       <div style="margin-top:3%;margin-left:-10%">
        ...
        <h5 style="margin-top:-6%;margin-left:23%;">Honda</h5>
       </div>
  </div>
